...
function insertImage() {
    ...
    // const DOCUMENT_ID = <?php echo (int) $_GET['documents_id']; ?>;
    input.type = "file";
    input.accept = "image/*";
    input.onchange = async function() {
        ...
        formData.append("document_id", DOCUMENT_ID); // Use PHP to inject this

        console.log("Sending image with document_id:", DOCUMENT_ID);
